...
- pre-mortem — if this is a T1/T2 launch and risk review hasn't happened yet
...
tigers exist, the user resolves those before returning to go-to-market-strategy.

## After a launch ships (no single skill owns this trigger)
**Next:** retro
